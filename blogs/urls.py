...
urlpatterns = [
    ...
    path('blogs/add/', views.AddView.as_view(), name='add'),
    path('blogs/edit/<int:pk>', views.EditView.as_view(), name='edit'),
    path('blogs/save/', views.SaveBlogView.as_view(), name='save'),
